...
export default function TableWithHistogram() {
    ...
    let bars = []
    for (let i in vals) {
        bars.push(<rect key={i} x={10} y={firstX+barWidth*parseInt(i)} width={vals[i]} height={barWidth} fill="none" stroke="#333" />)
    }
    ...
    return <div>
        ...
        <table style={{border: '1 solid', fontFamily: 'Courier, monospace'}}>
        <thead>
